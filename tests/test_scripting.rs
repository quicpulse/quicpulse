...
async fn test_crypto_sha256_hex() {
    let (code, stdout, stderr) = run_script_test(
        r#"
...
"#,
    ...
    assert!(
        code == 0,
        "crypto::hmac_sha256_base64 failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "crypto::random_bytes_base64 failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "date is_before/is_after failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "cookie::parse_set_cookie failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "store string operations failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "store utility functions failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "integration crypto+encoding failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "integration faker+store failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "integration url+encoding failed: {} {}",
        stdout,
        stderr
    );
}
...
"#,
    ...
    assert!(
        code == 0,
        "integration complete workflow failed: {} {}",
        stdout,
        stderr
    );
}
