...
pub fn register(ctx: &Ctx<'_>) -> Result<(), QuicpulseError> {
    ...
    regex_obj
        .set("test", Function::new(ctx.clone(), regex_test)?)
        .map_err(|e| QuicpulseError::Script(e.to_string()))?;
    regex_obj
        .set("match", Function::new(ctx.clone(), regex_match)?)
        .map_err(|e| QuicpulseError::Script(e.to_string()))?;
    regex_obj
        .set("find_all", Function::new(ctx.clone(), regex_find_all)?)
        .map_err(|e| QuicpulseError::Script(e.to_string()))?;
    regex_obj
        .set("replace", Function::new(ctx.clone(), regex_replace)?)
        .map_err(|e| QuicpulseError::Script(e.to_string()))?;
    regex_obj
        .set(
            "replace_all",
            Function::new(ctx.clone(), regex_replace_all)?,
        )
        .map_err(|e| QuicpulseError::Script(e.to_string()))?;
    regex_obj
        .set("split", Function::new(ctx.clone(), regex_split)?)
        .map_err(|e| QuicpulseError::Script(e.to_string()))?;
    regex_obj
        .set("escape", Function::new(ctx.clone(), regex_escape)?)
        .map_err(|e| QuicpulseError::Script(e.to_string()))?;
